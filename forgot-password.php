...
<div class="privacy">
	...
	<p style="width: 350px;">
			...
			<b>Email id</b>  <input type="email" name="email" class="form-control" id="email" pattern="[a-zA-Z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" placeholder="Reg Email id" required="">
	</p> 

	<p style="width: 350px;">
		
			<b>Mobile No</b>  <input type="text" name="mobile" class="form-control" minlength="10"maxlength="10"  pattern="[789][0-9]{9}" id="mobile" placeholder="Reg Mobile no" required="">
	</p> 

<p style="width: 350px;">
<b>New  Password</b>
<input type="password" class="form-control" name="newpassword" id="newpassword" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{6,}" placeholder="New Password" required="">
</p>

<p style="width: 350px;">
<b>Confirm Password</b>
	<input type="password" class="form-control" name="confirmpassword" id="confirmpassword" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{6,}" placeholder="Confrim Password" required="">
			</p>

...
$sql = "UPDATE tblcustomizedpackage SET adminremark=:remark WHERE  pid=:iid";
...
<div style="margin-left:50px;">
 <form name="updatecustomizedpackage" id="updatecustomizedpackage" method="post"> 
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr height="50">
      ...
      <td colspan="2" >  <?php if($error){?><div class="errorWrap"><strong>ERROR</strong>:<?php echo htmlentities($error); ?> </div><?php } 
            ...
            <tbody>
<?php 
$sql = "SELECT * from tblcustomizedpackage where pid=:iid";
$query = $dbh -> prepare($sql);
$query-> bindParam(':iid',$iid, PDO::PARAM_STR);
$query->execute();

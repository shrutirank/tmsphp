...
<?php } ?>
<link rel="shortcut icon" type="image/x-icon" href="<?php echo $RELATIVE_PATH ?>logo.ico"><link rel="icon" type="image/x-icon" href="<?php echo $RELATIVE_PATH ?>logo.ico">
...
<div class="wrapper ew-layout">
	...
	<aside class="<?php echo $SIDEBAR_CLASS ?>">
		...
		<a href="#" class="brand-link">
			<span class="brand-text">Holiday Planners</span>
		</a>
		<!-- Sidebar -->
		<div class="sidebar">
			<!-- Sidebar Menu -->

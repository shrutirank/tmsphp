...
class users_report_base extends ReportTable
{
	...
	public function __construct()
	{
		...
		// FullName
		$this->FullName = new ReportField('users_report_base', 'users report', 'x_FullName', 'FullName', '`FullName`', 200, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->FullName->Sortable = TRUE; // Allow sort
		$this->FullName->DateFilter = "";
		$this->fields['FullName'] = &$this->FullName;

		// MobileNumber
		$this->MobileNumber = new ReportField('users_report_base', 'users report', 'x_MobileNumber', 'MobileNumber', '`MobileNumber`', 200, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->MobileNumber->Sortable = TRUE; // Allow sort
		$this->MobileNumber->DateFilter = "";
		$this->fields['MobileNumber'] = &$this->MobileNumber;

		// EmailId
		$this->EmailId = new ReportField('users_report_base', 'users report', 'x_EmailId', 'EmailId', '`EmailId`', 200, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->EmailId->Sortable = TRUE; // Allow sort
		$this->EmailId->DateFilter = "";
		$this->fields['EmailId'] = &$this->EmailId;

		// RegDate
		$this->RegDate = new ReportField('users_report_base', 'users report', 'x_RegDate', 'RegDate', '`RegDate`', 135, 0, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->RegDate->Sortable = TRUE; // Allow sort
		$this->RegDate->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $ReportLanguage->phrase("IncorrectDate"));
		$this->RegDate->DateFilter = "";
		$this->fields['RegDate'] = &$this->RegDate;

		// UpdationDate
		$this->UpdationDate = new ReportField('users_report_base', 'users report', 'x_UpdationDate', 'UpdationDate', '`UpdationDate`', 135, 0, FALSE, 'FORMATTED TEXT', 'TEXT');

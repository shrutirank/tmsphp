...
$sql="INSERT INTO tbltourpackages(PackageName,PackageType,PackageLocation,PackagePrice,fdate,tdate,noofday,PackageFetures,PackageDetails,PackageImage,HotelDetails,Vehicle,Offer,offer_edate,HotelImage) VALUES(:pname,:ptype,:plocation,:pprice,:fdate,:tdate,:noofday,:pfeatures,:pdetails,:pimage,:pHotelDetails,:Vehicle,:Offer,:pofferedate,:phimage)";
...
$query->bindParam(':pofferedate',$pofferedate,PDO::PARAM_STR);
$query->bindParam(':phimage',$phimage,PDO::PARAM_STR);
$query->execute();
						...
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal" name="package" method="post" enctype="multipart/form-data">
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="packagename" id="packagename" pattern="[A-Za-z]{2,30}" placeholder="Create Package" required>
									</div>
								</div>
<div class="form-group">
...
<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="packageprice" id="packageprice" pattern="\d{1,9}" placeholder=" Package Price" required>
									</div>
								</div>
<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">From Date</label>
									<div class="col-sm-8">
										<input type="date" class="form-control1" name="fdate" id="fdate" required>
									</div>
								</div>
<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">To Date</label>
									<div class="col-sm-8">
										<input type="date" class="form-control1" name="tdate" id="tdate" required>
									</div>
								</div>
...
<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input class="form-control" rows="5" cols="50" name="noofday" id="noofday" placeholder="No. of days" required></input> 
									</div>
								</div>
<div class="form-group">
...
<div class="form-group">
								...
								<div class="col-sm-8">
								<select class="col-sm-8" id="Vehicle" name="Vehicle" >

<?php
$conn=mysqli_connect("localhost","root","");
mysqli_select_db($conn,"tms");
$q="select * from tblvehicel";
...
?>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="Offer" id="Offer" >
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="date" class="form-control1" name="offeredate" id="offeredate" >
									</div>
								</div>

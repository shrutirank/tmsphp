...
define(PROJECT_NAMESPACE . "RANDOM_KEY", 'zDhk7Nb4gycMrJai'); // Random key for encryption
...
$PROJECT_ID = "{76773FBE-0F08-4E30-961F-B791BA08FBCC}"; // Project ID (GUID)
$RELATED_PROJECT_ID = "";
...
$CONNECTIONS["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "", "db" => "tms", "qs" => "`", "qe" => "`");

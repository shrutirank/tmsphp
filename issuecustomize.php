...
<div class="privacy">
	<div class="container">
		<h3 class="wow fadeInDown animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInDown;">Customized Package</h3>
...
$sql = "SELECT * from tblcustomizedpackage where UserEmail=:uemail";
...
<td width="100">#cp-<?php echo htmlentities($result->pid);?></td>
